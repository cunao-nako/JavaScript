window.addEventListener('DOMContentLoaded', () => {
  ...
  function feedBack(message) {
    let prevDialog = modalWindow.querySelector('.modal__dialog');

    if (modalWindow.querySelector('.new')) { modalWindow.querySelector('.new').remove(); }
  ...
  function closeModalWindow() {
    if (modalWindow.querySelector('.new')) { modalWindow.querySelector('.new').remove(); }
    if (modalWindow.querySelector('.modal__dialog').getAttribute('style')) {
      modalWindow.querySelector('.modal__dialog').removeAttribute('style');
    }
